...
import net.hus.core.shared.common.EnumLookup;
import net.hus.core.shared.common.IsOption;
...
public abstract class EnumUtil
{
  ...
  public static <T extends Enum<?>> IsOption toOption(final T inEnum, final String inDisplay)
  {
    if (inEnum == null)
    {
      return null;
  ...
  public static <T extends Enum<T>> String asString(EnumLookup inLookup, List<T> inEnums)
  {
    StringBuilder sb = new StringBuilder();
    if (inEnums != null)
    {
