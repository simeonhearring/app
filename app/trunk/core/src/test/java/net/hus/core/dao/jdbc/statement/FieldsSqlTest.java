...
public class FieldsSqlTest extends MySqlCoreDsTest
{
  ...
  // ret.setProperties(new Array.Properties(500, 10, true, "#CCC", "#FFF",
  // HeadingSize.H5));
  // return ret;
  // }
  //
  // private Field newField(Type inType, String inName, String inLong, String
  // inShort)
  // {
  // Field ret = new Field();
  // ret.setName(inName);
